...
3. Five sensors appear under a single **UTE Tarifas** device:

   | Sensor | What it shows |
   |--------|---------------|
   | `sensor.ute_tarifas_current_cost` | Current UYU/kWh rate |
...
- **Weekends and holidays are always all-valle** for Double and Triple contracts
